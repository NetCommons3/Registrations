 ...
 *
 * @author Allcreator <info@allcreator.net>
 * @package NetCommons\Questionaires\Test\Case\Controller\RegistrationEditController
 */
class RegistrationEditControllerEditResultTest extends WorkflowControllerEditTest {
 ...
 */
	public function dataProviderEditGetByEditable() {
		...
		array_push($results, Hash::merge($results[$base], array(
			'assert' => array('method' => 'assertInput', 'type' => 'input', 'name' => 'data[Registration][is_total_show]', 'value' => null),
		)));
		array_push($results, Hash::merge($results[$base], array(
			'assert' => array('method' => 'assertInput', 'type' => 'textarea', 'name' => 'data[Registration][total_comment]', 'value' => null),
		)));
		...
		return array(
			Hash::merge($result, array(
				'validationError' => array(
					'field' => 'Registration.is_total_show',
					'value' => 'aa',
			...
			Hash::merge($result, array(
				'validationError' => array(
					'field' => 'RegistrationPage.0.RegistrationQuestion.0.is_result_display',
					'value' => 'aa',
			...
			Hash::merge($result, array(
				'validationError' => array(
					'field' => 'RegistrationPage.0.RegistrationQuestion.0.result_display_type',
					'value' => 'aa',
			...
			Hash::merge($result, array(
				'validationError' => array(
					'field' => 'RegistrationPage.0.RegistrationQuestion.0.RegistrationChoice.0.graph_color',
					'value' => 'aa',
