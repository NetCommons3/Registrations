<?php
/**
 * RegistrationFrameSettingsController Test Case
 *
 ...
 */
class RegistrationsFrameSettingsControllerEditTest extends NetCommonsControllerTestCase {
 ...
 * @var string
 */
	protected $_controller = 'registration_frame_settings';
 ...
 */
	private function __getData() {
		...
		for ($i = 1; $i <= 50; $i = $i + 2) {
			...
			$displayQ['List']['RegistrationFrameDisplayRegistration'][] = array('is_display' => '1', 'registration_key' => 'registration_' . strval($i + 1));
		}
		$displayQ['Single']['RegistrationFrameDisplayRegistration']['registration_key'] = 'registration_2';
		...
		return array(
			...
			Hash::merge($result, array(
				'validationError' => array(
					'field' => 'RegistrationFrameSetting.display_type',
					'value' => 'ssss',
