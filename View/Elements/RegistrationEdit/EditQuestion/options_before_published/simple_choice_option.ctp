			...
			<li class="list-group-item" ng-repeat="(cIndex, choice) in question.registrationChoice" >
				<div class="form-inline pull-right">
					<select name="data[RegistrationPage][{{pageIndex}}][RegistrationQuestion][{{qIndex}}][RegistrationChoice][{{cIndex}}][skip_page_sequence]"
						...
						<option ng-repeat="skipPage in registration.registrationPage | toArray | filter: greaterThan('pageSequence', page)"
...
<div class="row" ng-if="question.questionType != <?php echo RegistrationsComponent::TYPE_SINGLE_SELECT_BOX; ?>">
	<div class="col-sm-12">
