...
NetCommonsApp.controller('RegistrationsAnswer',
    function($scope, $sce, $timeout, $log, NetCommonsBase, NetCommonsFlash) {
      ...
      $scope.initialize = function(registrationPage, answers) {
        ...
        for (var qIdx = 0;
             qIdx < registrationPage.registrationQuestion.length;
             qIdx++) {
...
NetCommonsApp.controller('RegistrationsFrame',
    function($scope, $sce, $log, NetCommonsBase, $attrs, $timeout) {
       ...
       * @return {void}
       */
      $scope.initialize = function(registrations,
                                   registrationFrameSettings) {
        ...
        for (var i = 0; i < $scope.registrations.length; i++) {
          if ($scope.registrations[i].
              registrationFrameDisplayRegistration.id) {
