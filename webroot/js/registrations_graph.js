/**
 * @fileoverview Registration graph Javascript
...
/**
 * Registration Graph Javascript
 *
 * @param {string} Controller name
 * @param {function($scope)} Controller
 */
NetCommonsApp.controller('RegistrationsAnswerSummary',
    function($scope, $window, $sce, $timeout, $log) {
        ...
        for (var key in $scope.questions) {
          ...
          if ($scope.questions[key].resultDisplayType ==
            ...
            if ($scope.questions[key].questionType == variables.TYPE_MATRIX_MULTIPLE ||
              ...
              for (var choiceId in $scope.questions[key]['registrationChoice']) {
                var choice = $scope.questions[key]['registrationChoice'][choiceId];
      ...
      $scope.getColorArray = function(question) {
        ...
        for (var choiceKey in question.registrationChoice) {
          var choice = question.registrationChoice[choiceKey];
      ...
      $scope.getMatrixPieData = function(question, choice) {
        ...
        var colChoice = new Object();
        for (var choiceKey in question.registrationChoice) {
          if (question.registrationChoice[choiceKey].matrixType !=
              variables.MATRIX_TYPE_ROW_OR_NO_MATRIX) {
            colChoice[question.registrationChoice[choiceKey].key] =
                question.registrationChoice[choiceKey];
          }
        }
